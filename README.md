...
## Project Description:
The first part of the AirBnB clone project - The Console. We are introduced to backend programming and interacting with the console application (cmd module in python)

We will work on the serialization and deserialization of our data (python objects) using JSON

## Command Interpreter Description
Similar to the Shell but limited to a specific use-case. We want to be able to manage the objects of our project:
...
```
git clone https://github.com/mosixty1234/AirBnB_clone.git
```

After cloning the repository, cd into AirBnB_clone directory
...
You can have a single test file to run at a time:

```
$ python3 unittest -m tests/test_console.py
```
## Authors:
- Karabo Mashile <[Kb-Mash](https://github.com/Kb-Mash)>
- Sipho Dlamini <[mosixty1234](https://github.com/mosixty1234)>
